...
public class Mat4 extends BufferableData<FloatBuffer> {
	...
	public static Mat4 inverse(Mat4 m) {
		...
		inv[0] = m.matrix[5]  * m.matrix[10] * m.matrix[15] -
		...
		inv[4] = -m.matrix[4]  * m.matrix[10] * m.matrix[15] +
		...
		inv[8] = m.matrix[4]  * m.matrix[9] * m.matrix[15] -
		...
		inv[12] = -m.matrix[4]  * m.matrix[9] * m.matrix[14] +
		...
		inv[1] = -m.matrix[1]  * m.matrix[10] * m.matrix[15] +
		...
		inv[5] = m.matrix[0]  * m.matrix[10] * m.matrix[15] -
		...
		inv[9] = -m.matrix[0]  * m.matrix[9] * m.matrix[15] +
		...
		inv[13] = m.matrix[0]  * m.matrix[9] * m.matrix[14] -
		...
		inv[2] = m.matrix[1]  * m.matrix[6] * m.matrix[15] -
		...
		inv[6] = -m.matrix[0]  * m.matrix[6] * m.matrix[15] +
		...
		inv[10] = m.matrix[0]  * m.matrix[5] * m.matrix[15] -
		...
		inv[14] = -m.matrix[0]  * m.matrix[5] * m.matrix[14] +
		...
		inv[3] = -m.matrix[1] * m.matrix[6] * m.matrix[11] +
		...
		inv[7] = m.matrix[0] * m.matrix[6] * m.matrix[11] -
		...
		inv[11] = -m.matrix[0] * m.matrix[5] * m.matrix[11] +
		...
		inv[15] = m.matrix[0] * m.matrix[5] * m.matrix[10] -
		...
		det = m.matrix[0] * inv[0] + m.matrix[1] * inv[4] + m.matrix[2] * inv[8] + m.matrix[3] * inv[12];
